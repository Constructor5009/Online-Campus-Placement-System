...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="orders.aspx">View students<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="jobPost.aspx">View companies</a>
      </li>
   ...
   <form class="form-inline my-2 my-lg-0">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="details.aspx">Round 1</a>
                      <a class="dropdown-item" href="details.aspx">Round 2</a>
          <a class="dropdown-item" href="details.aspx">Round 3</a>
            </div>
             </li>
          <li class="nav-item">
