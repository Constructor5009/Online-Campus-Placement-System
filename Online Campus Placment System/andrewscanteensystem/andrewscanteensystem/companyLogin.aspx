<%@ Page Language="C#" AutoEventWireup="true" Codefile="companyLogin.aspx.cs" Inherits="andrewscanteensystem.companyLogin" %>
...
<body>
  ...
  <h2 class="text-center">&nbsp;&nbsp;Company Login</h2><br />
          ...
          <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Forgetpass.aspx">Forgot Password?</asp:HyperLink>
            ...
            <div>
                Not a member? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/comReg.aspx">Sign Up</asp:HyperLink>
            </div>
                <div>
