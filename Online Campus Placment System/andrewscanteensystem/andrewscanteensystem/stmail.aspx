<%@ Page Language="C#" AutoEventWireup="true" Codefile="stmail.aspx.cs" Inherits="andrewscanteensystem.stmail" %>
   ...
   <form class="form-inline my-2 my-lg-0">
    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
            <strong>Send Email to Students<br />
            </strong></div><br />
        ...
        <p class="text-center">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="sapId" DataSourceID="SqlDataSource1" HorizontalAlign="Center">
                <Columns>
        ...
        <p class="text-center">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentlogConnectionString %>" SelectCommand="SELECT [sapId], [fname], [lname], [email] FROM [stuData]"></asp:SqlDataSource>
        </p>
        <p class="text-center">
