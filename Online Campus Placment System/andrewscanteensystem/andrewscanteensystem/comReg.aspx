<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comReg.aspx.cs" Inherits="andrewscanteensystem.Staffreg" %>
            ...
            <div class="col-6">
                ...
                <table class="w-100">
                    ...
                    <tr>
                        ...
                        <td class="auto-style27"><br /><asp:Button ID="Button1" runat="server" Text="Register" CssClass="btn btn-dark" OnClick="Button1_Click" Height="35px" Width="153px"/>&nbsp;</td>
                        <td class="auto-style23">
                            &nbsp;</td>
                    </tr>
