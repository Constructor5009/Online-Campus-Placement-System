<%@ Page Language="C#" AutoEventWireup="true" Codefile="stuDetail.aspx.cs" Inherits="andrewscanteensystem.stuDetail" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="table table table-sm table-secondary table-borderless table-hover">
                ...
                <tr><th scope="row" colspan="5" class="auto-style1"><strong>Enter Your Details</strong></th></tr></thead>
                <tr>
...
&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style5">Sap Id:&nbsp;</td>
                    <td class="auto-style7">&nbsp;<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                ...
                <tr>
<th scope="row" colspan="5" class="auto-style3"><strong>Xth Details</strong></th>
...
&nbsp;</td>
                                      ...
                                      <thead class="thead-light">
                <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong> XII Details</strong></th>
...
&nbsp;</td>
                 ...
                 <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Degree Details</strong></th>
...
&nbsp;</td>
                                      ...
                                      <thead class="thead-light">
                 <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Postgraduation Details</strong></th>
...
&nbsp;</td>
                ...
                <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Other Details</strong></th>
                ...
                <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Courses</strong></th>
...
&nbsp;</td>
                 ...
                 <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Internship Details</strong></th>
...
&nbsp;</td>
                ...
                <tr>
                 ...
                 <tr>
                    <th scope="row" colspan="5" class="auto-style3"><strong>Project Details</strong></th>
