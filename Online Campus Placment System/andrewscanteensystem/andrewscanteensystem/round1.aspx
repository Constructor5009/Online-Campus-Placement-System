<%@ Page Language="C#" AutoEventWireup="true" Codefile="round1.aspx.cs" Inherits="andrewscanteensystem.round1" %>
...
&nbsp;<asp:Button ID="Button4" runat="server" OnClick="Button4_Click1" Text="Submit" CssClass="btn btn-dark"/>
                         </td>
                     </tr></thead>
...
&nbsp;
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:StudentlogConnectionString %>" SelectCommand="SELECT * FROM [round1] WHERE ([jobid] = @jobid)">
            <SelectParameters>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand" OnRowUpdating="GridView2_RowUpdating" CellSpacing="2" ForeColor="Black">
        ...
        <br />
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentlogConnectionString %>" SelectCommand="SELECT * FROM [round1] WHERE ([jobid] = @jobid)">
             <SelectParameters>
                 <asp:ControlParameter ControlID="TextBox1" Name="jobid" PropertyName="Text" Type="Int32" />
             </SelectParameters>
         </asp:SqlDataSource>
