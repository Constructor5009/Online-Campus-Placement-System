<%@ Page Language="C#" AutoEventWireup="true" Codefile="round33.aspx.cs" Inherits="andrewscanteensystem.round33" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand" OnRowUpdating="GridView2_RowUpdating" CellSpacing="2" ForeColor="Black">
        ...
        <br />
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentlogConnectionString %>" SelectCommand="SELECT * FROM [round3] WHERE ([jobid] = @jobid)">
             <SelectParameters>
...
<asp:Button ID="Button2" runat="server" OnClick="Button2_Click" CssClass="btn btn-dark" Text="Show Selected Students" />
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="sapId" DataSourceID="SqlDataSource3" HorizontalAlign="Center">
            <Columns>
               ...
               <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:StudentlogConnectionString %>" SelectCommand="SELECT * FROM [selectedCandidates] WHERE ([jobid] = @jobid)">
                   <SelectParameters>
                       <asp:ControlParameter ControlID="TextBox1" Name="jobid" PropertyName="Text" Type="Int32" />
                   </SelectParameters>
        </asp:SqlDataSource>
