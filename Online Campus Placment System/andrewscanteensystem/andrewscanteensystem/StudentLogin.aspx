<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentLogin.aspx.cs" Inherits="andrewscanteensystem.WebForm2" %>
...
<body>
  ...
  <h2>&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Student Login</h2><br />
          ...
          <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Forgetpass.aspx">Forgot Password?</asp:HyperLink>
            ...
            <div>
                Not a member? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Studentreg.aspx">Sign Up</asp:HyperLink>
            </div>
                <div>
