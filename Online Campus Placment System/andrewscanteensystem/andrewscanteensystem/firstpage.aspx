...
<body>
  ...
  <div class="form-group">
     <asp:Button ID="Button2" runat="server" Text="Company Login" CssClass="btn btn-dark btn-block " PostBackUrl="~/companyLogin.aspx"/>
      </div><br />
   ...
   <asp:Button ID="Button3" runat="server" Text="Student Login" CssClass="btn btn-dark btn-block " PostBackUrl="~/StudentLogin.aspx"/>
          ...
          <br />
                   ...
                   <div class="form-group">
     <asp:Button ID="Button1" runat="server" Text="Admin Login" CssClass="btn btn-dark btn-block " PostBackUrl="~/adlogin.aspx"/>
      </div>
