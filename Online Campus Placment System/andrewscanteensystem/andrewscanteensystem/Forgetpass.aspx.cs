    ...
    public partial class Forgetpass : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                sendpassworde(decryptedpwd, email);
        ...
        private void sendpassworde(String password, String email)
        {
            ...
            {
                //Label3.Text = "Data Found";
                emaill = ds.Tables[0].Rows[0]["Email"].ToString();

                passwor = ds.Tables[0].Rows[0]["Stpassword"].ToString();
                decryptpwd(passwor);

                sendpassworde(decryptedpwd, emaill);
            ...
            msg.Subject = "Forgot Password (Placement Cell)";
            msg.Body = "Dear " + TextBox1.Text + ", Your Password is  " + password + "\n\n\nThanks & Regards\nMPSTME NMIMS";
            string toaddress = email;
            msg.To.Add(toaddress);
            string fromaddress = "Placement Cell";
