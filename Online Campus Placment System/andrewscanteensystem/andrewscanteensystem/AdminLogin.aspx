<%@ Page Language="C#" AutoEventWireup="true" Codefile="AdminLogin.aspx.cs" Inherits="andrewscanteensystem.AdminLogin" %>
...
<body>
  ...
  <h2>&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admin Login</h2><br />
          ...
          <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Forgetpass.aspx">Forgot Password?</asp:HyperLink>
                   ...
                   <asp:Button ID="Button1" runat="server" Text="Sign In" CssClass="btn btn-dark btn-block " OnClick="Button1_Click" PostBackUrl="~/mainadmin.aspx"/>
  
</form>
            
            <div>
                Not a member? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Adminreg.aspx">Sign Up</asp:HyperLink>
            </div>
                <div>
